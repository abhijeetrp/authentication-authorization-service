...
class AuthenticationControllerTest {
    ...
    void shouldReturnTokenWhenSignupInvoked() throws  Exception{
        ...
        when(jwtService.generateToken(any(User.class))).thenReturn("eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJyYWphNjNAZ21haWwuY29tIiwiZXhwIjoxNjYzNjkyNzQ3LCJpYXQiOjE2NjM2NTY3N");
        mvc.perform(post(API_V1_AUTH+"/signup").contentType(MediaType.APPLICATION_JSON).content(mapper.writeValueAsString(getSampleUser()))).
                andExpect(status().isOk())
                .andDo(print());
    }
